...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=F7A700&center=true&width=440&lines=Flutter+Developer+%7C+Web+Developer;UI%2FUX+Designer+%7C+CS+Student;" alt="Typing SVG" />
</p>
...
- 🧠 Passionate about **mobile & web development**, and **user-centric design**
- 🌱 Currently enhancing my UI/UX skills at **Digital Egypt Pioneers (DEPI)**
- 💼 Former **Head of Design** @ GDSC PUA & active Vice Head of web development committee @ IEEE-PUA SB
- 📍 Alexandria, Egypt
...
#### 🛠 **Tools**
`VS Code` `Android Studio` `Postman` `Firebase Console`  
`Notion`  `Git & GitHub`
